...
(function () {
    ...
    _style.textContent = '\
        ...
        .moon-open-button::before {\
            content: "\01F319"; font-size: 32px; position: absolute; z-index: 1;\
        ...
        .moon-view .moon-title::before {\
            content: "\01F319"; position: absolute; left: 12px; font-size: 18px; opacity: 0.8;\
        }\
    ...
    // ===================== 事件绑定 =====================
    _ball.addEventListener('click', function () {
